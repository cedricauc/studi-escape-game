# Generated by Django 3.2.7 on 2022-10-09 12:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(blank=True, choices=[(0, 'Admin'), (1, 'Client'), (2, 'Employee')], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ticket_answer', to='main.ticketquestion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games_details', to='main.booking')),
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games_details', to='main.game')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='game',
            name='scenario',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='games', to='main.scenario'),
        ),
        migrations.CreateModel(
            name='Discount',
            fields=[
                ...
                ('scenarios', models.ManyToManyField(blank=True, to='main.Scenario')),
            ],
            options={
                'db_table': 'discount',
            },
